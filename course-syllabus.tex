...
\begin{tabular}{ll}
\hspace{-.25in}\textbf{Instructor:} Mehdi Maadooliat, Ph.D. & \hspace{-.15in} \textbf{TA: Soroush Mahmoudiandehkordi}  \\ 
e-mail: \href{mailto:mehdi.maadooliat@marquette.edu}{mehdi.maadooliat@marquette.edu} & \hspace{.0in} e-mail: \href{mailto:soroush.mahmoudiandehkordi@marquette.edu}{soroush.mahmoudiandehkordi@marquette.edu} \\
website: \href{http://www.mscs.mu.edu/~mehdi}{http://www.mscs.mu.edu/ $\widetilde{ }$mehdi} & \hspace{.0in} Office: CU 368\\
Office Hours: T (CU 351) \& Th (HelpDesk) 12:15 - 1:30pm & \hspace{.0in} Help Desk Location: 4th floor Cudahy Hall \\
Office: CU 351 & \hspace{.0in} \href{https://www.marquette.edu/mathematical-and-statistical-sciences/documents/student-resources-math-1700-4720-help-desk.pdf}{Help Desk Hours}
\end{tabular}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{description}
